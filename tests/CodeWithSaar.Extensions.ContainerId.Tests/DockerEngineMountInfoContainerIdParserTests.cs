...
public class DockerEngineMountInfoContainerIdParserTests
{
    ...
    {
        IContainerIdParser<DockerEngineMountInfoContainerIdProvider> target = new DockerEngineMountInfoContainerIdParser();
